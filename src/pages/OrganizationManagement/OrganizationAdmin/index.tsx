...
const OrganizationAdmin: React.FC = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const data = await getAllOrganizationUsers(filters, organizationId!);
        ...
        cell: ({ row }): React.ReactNode => {
          return (
            <Box
              ...
              alignItems="center"
            >
              {row.original.userId !== basicUserDetails?.userId && (
                <Switch
                  size="small"
              ...
              {/* {!row.original.isOrganizationAdmin && (
                <IconButton
                  size="small"
                  variant="soft"
                  onClick={() => {
                    const email = row.original.userDetails.email;
  ...
  return (
    <>
        ...
        >
          ...
          <Box display="flex" flexDirection="row" gap={1}>
            ...
            <Button
              ...
              onClick={(event) => {
                event.stopPropagation();
                void navigate({ to: '/organization-admin/manage-approvals' });
              }}
            >
              Manage Approvals
            </Button>
      ...
      <TableContainerComponent
        ...
        isLoading={isLoading || usersTableData.users.length === 0}
      ...
      <InviteUser
        ...
        shouldShowUserTypeDropdown={basicUserDetails?.role === 'legal_user'}
      />
    </>
  );
};
